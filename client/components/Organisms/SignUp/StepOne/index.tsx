...
import { AccountTitle, InputBox, ValidationMessage, SignUpBtn } from "./styles";
import EmailDuplicateCheckBtn from "components/Atoms/SignUp/EmailDuplicateCheckBtn";
    ...
    <>
      ...
      <div>
        ...
        {password !== "" && !passwordValidation && (
          <ValidationMessage>최소 8 자, 최소 하나의 문자, 하나의 숫자 및 하나의 특수 문자가 필요합니다</ValidationMessage>
        )}
      </div>
      <div>
